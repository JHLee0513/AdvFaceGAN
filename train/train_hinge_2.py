...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch == 0:
            f = open("./train_log_hinge_2.txt", 'w')
        else:
            f = open("./train_log_hinge_2.txt", 'a')
        ...
        if (valid_acc > best_valid):
            f.write("New best!\n")
            torch.save(g_m.state_dict(), "./generator_hinge_2.pth")
            torch.save(d_m.state_dict(), "./discriminator_hinge_2.pth")
